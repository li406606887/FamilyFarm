...
#import "IntegralStoreSearchView.h"

@interface IntegralStoreView ()<UICollectionViewDelegate,UICollectionViewDataSource>
@property(nonatomic,strong) UICollectionView *collectionView;
@property(nonatomic,strong) IntegralStoreSearchView *searchView;
@property(nonatomic,strong) IntegralStoreViewModel *viewModel;
@end

@implementation IntegralStoreView
-(instancetype)initWithViewModel:(id<BaseViewModelProtocol>)viewModel{
    self.viewModel = (IntegralStoreViewModel *)viewModel;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    IntegralStoreCollectionViewCell *cell =[collectionView dequeueReusableCellWithReuseIdentifier:[NSString stringWithUTF8String:object_getClassName([IntegralStoreCollectionViewCell class])] forIndexPath:indexPath];
...
-(UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[IntegralStoreCollectionViewCell class] forCellWithReuseIdentifier:[NSString stringWithUTF8String:object_getClassName([IntegralStoreCollectionViewCell class])]];
...
-(IntegralStoreSearchView *)searchView {
    if (!_searchView) {
        _searchView = [[IntegralStoreSearchView alloc] init];
    }
    return _searchView;
}
@end
